...
app.get('/', (req, res) => {
  res.json([
    { key: 0, moeda: 'BRL', name: 'Brasil Real', sobre: 'O Real é a moeda corrente oficial da República Federativa do Brasil. Após sucessivas trocas monetárias, o Brasil adotou o real em 1 de julho de 1994, que, aliado à drástica queda das taxas de inflação, constituiu uma moeda estável para o país. ',img:'https://image.freepik.com/vetores-gratis/projeto-de-brasil-sobre-ilustracao-vetorial-de-fundo-branco_24908-47741.jpg' },
